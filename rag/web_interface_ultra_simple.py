"""
Ultra Simple Web Interface for Environmental Law RAG System (No Dependencies Conflicts)
A Flask-based web interface for the ultra-simple RAG system
"""
...
def initialize_rag():
    ...
    if rag_system is None:
        rag_system = UltraSimpleEnvironmentalLawRAG(pdf_directory=".")
...
def query_rag():
    ...
    try:
        if not initialize_rag():
            return jsonify({
                'error': 'RAG system not initialized. Please run setup_rag_ultra_simple.py first.'
            }), 500
...
<head>
    ...
    <title>Environmental Law RAG System (Ultra Simple & Free)</title>
    <style>
        body {
...
<body>
    <div class="container">
        <h1>🌍 Environmental Law RAG System <span class="free-badge">FREE</span><span class="ultra-simple-badge">ULTRA SIMPLE</span></h1>
        
        <div class="info-box">
            <strong>ℹ️ No API Keys Required!</strong> This system runs entirely on your local machine using only stable, well-tested libraries. No dependency conflicts!
        </div>
        
        <div class="tech-info">
            <strong>🔧 Technology:</strong> Uses TF-IDF (Term Frequency-Inverse Document Frequency) for fast and reliable text similarity. No complex embeddings or heavy dependencies!
        </div>
    ...
    with open(templates_dir / 'index_ultra_simple.html', 'w', encoding='utf-8') as f:
        f.write(html_template)
    
    print("🌍 Environmental Law RAG System (Ultra Simple & Free)")
    print("=" * 70)
    print("✅ No API keys required!")
    print("✅ No dependency conflicts!")
    print("✅ Uses only stable, well-tested libraries!")
    print("✅ Runs entirely on your local machine!")
    print("✅ Uses TF-IDF for fast and reliable text similarity!")
    print("")
